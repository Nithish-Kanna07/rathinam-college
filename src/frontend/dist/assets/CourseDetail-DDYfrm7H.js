import { c as createLucideIcon, u as useParams, r as reactExports, j as jsxRuntimeExports, L as Link, G as GraduationCap, P as Phone, M as Mail } from "./index-zlr7lLpe.js";
import { B as Badge, S as Section } from "./Section--4kNx3lt.js";
import { c as useSubmitCourseInquiry } from "./useBackend-C_lmyPCj.js";
...
const COURSE_DETAILS = {
  "be-cse": {
    ...
    description: "A comprehensive 4-year program blending theory and hands-on practice across AI, ML, cloud computing, full-stack development and cybersecurity. Graduates emerge as industry-ready engineers equipped for top global companies.",
    eligibility: "10+2 with Physics, Chemistry & Mathematics — minimum 60% aggregate. TNEA rank holders preferred.",
    avgLPA: "18 LPA",
    highestLPA: "42 LPA",
    placementRate: "98%",
    highlights: [
  ...
  "be-ece": {
    ...
    description: "An advanced program covering VLSI design, embedded systems, 5G communications, and IoT. Students gain hands-on experience in state-of-the-art electronics labs and industry-sponsored projects.",
    eligibility: "10+2 with Physics, Chemistry & Mathematics — minimum 60% aggregate.",
    avgLPA: "12 LPA",
    highestLPA: "24 LPA",
    placementRate: "95%",
    highlights: [
  ...
  mba: {
    ...
    description: "Industry-immersive MBA with dual specialization in Marketing, Finance, HR, or Operations. Live projects, executive speakers, and national B-school competitions define the two-year journey.",
    eligibility: "Any UG degree with minimum 50% aggregate. CAT/MAT/TANCET scores preferred.",
    avgLPA: "14 LPA",
    highestLPA: "30 LPA",
    placementRate: "96%",
    highlights: [
...
function buildFallback(id) {
  return {
    ...
    description: "An industry-aligned program designed to equip students with practical skills, theoretical knowledge, and professional readiness for rewarding careers.",
...
function CourseDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "course_detail.page", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "mb-3", children: course.department }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4 leading-tight", children: course.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-base leading-relaxed mb-6", children: course.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 bg-primary-foreground/10 rounded-lg px-3 py-1.5 text-primary-foreground text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14, className: "text-secondary" }),
                      course.duration
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 bg-primary-foreground/10 rounded-lg px-3 py-1.5 text-primary-foreground text-sm", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 bg-secondary/20 rounded-lg px-3 py-1.5 text-secondary text-sm font-bold", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-6 text-center", children: [
          {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { size: 22, className: stat.color }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { "data-ocid": "course_detail.details.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: "Program Highlights" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: course.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: "Learning Outcomes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: course.outcomes.map((o, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-primary text-primary-foreground text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shrink-0 mt-0.5", children: i + 1 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground", children: o })
              ]
            },
            o
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "inline mr-2 text-primary", size: 22 }),
            "Semester-wise Curriculum"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: course.curriculum.map((sem, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/8 px-5 py-3 flex items-center gap-3 border-b border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-7 h-7 rounded-full bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center", children: i + 1 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground text-sm", children: sem.sem })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 flex flex-wrap gap-2", children: sem.subjects.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "inline mr-2 text-secondary", size: 22 }),
            "Placement Records"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4", children: course.placements.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-muted mx-auto mb-2 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: p.logo,
                    alt: p.company,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground text-sm", children: p.company }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mb-2", children: p.role }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "placement", children: p.lpa })
              ]
            },
            p.company
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "inline mr-2 text-accent", size: 22 }),
            "Meet the Faculty"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-5", children: course.faculty.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              whileInView: { opacity: 1, y: 0 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-sm", children: f.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs font-semibold mb-1", children: f.designation }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed mb-2", children: f.specialization }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "muted", children: f.experience })
              ]
            },
            f.name
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-bold text-foreground mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "inline mr-2 text-primary", size: 22 }),
            "Industry Partners"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: course.partners.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "course_detail.sidebar.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary rounded-2xl p-6 text-primary-foreground sticky top-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-3", children: "Eligibility Criteria" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm leading-relaxed mb-4", children: course.eligibility }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-5 border-t border-primary-foreground/20 pt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70", children: "Duration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: course.duration })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70", children: "Annual Fee" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-secondary", children: course.fee })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70", children: "Total Seats" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: course.seats })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70", children: "Avg Package" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-secondary", children: course.avgLPA })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-2", children: "Program Brochure" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: "Download the detailed program guide with fee structure and syllabus." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "mb-3", children: "Get In Touch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground mb-2", children: "Request Program Information" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Our admissions counsellor will contact you within 24 hours." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 48, className: "text-accent mx-auto mb-4" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground mb-2", children: "Request Submitted!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "We'll reach out to you within 24 hours with full program details." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/courses", className: "btn-primary mt-6 inline-block", children: "Explore More Programs" })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                        {
                          className: "block text-sm font-semibold text-foreground mb-1.5",
                          htmlFor: "inq-program",
                          children: "Program Interested In"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                        {
                          className: "block text-sm font-semibold text-foreground mb-1.5",
                          htmlFor: "inq-message",
                          children: "Your Questions / Message"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "textarea",
