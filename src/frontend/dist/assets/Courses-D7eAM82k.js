import { r as reactExports, j as jsxRuntimeExports, G as GraduationCap, L as Link } from "./index-zlr7lLpe.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg mb-8 leading-relaxed", children: "Choose from 16 undergraduate and postgraduate programs across Engineering, Science, Arts, and Management. Every program is AICTE-approved, industry-aligned, and placement-focused." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 mb-8 text-lg", children: "Applications are open for the 2025–26 academic year. Secure your seat today." }),
