import { c as createLucideIcon, j as jsxRuntimeExports, G as GraduationCap, P as Phone, r as reactExports, C as ChevronDown, M as Mail } from "./index-zlr7lLpe.js";
import { c as cn, B as Badge, S as Section } from "./Section--4kNx3lt.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admissions.page", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg mb-8 leading-relaxed max-w-xl", children: "Join Rathinam College — where world-class education meets industry-ready skills. Applications are open for all UG, PG, and MBA programs." }),
            ...
            "tr",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: p.type === "UG" ? "primary" : p.type === "PG" ? "accent" : "secondary",
                    children: p.type
                  }
                ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Section,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5", children: brochures.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
      ...
      Section,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 leading-relaxed text-sm", children: "Fill out the inquiry form and our admissions counselor will contact you within 24 hours to guide you through the process, answer all your questions, and help you select the right program." }),
