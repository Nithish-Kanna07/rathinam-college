import { j as jsxRuntimeExports } from "./index-zlr7lLpe.js";
function r(e) {
  var t, f, n = "";
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: cn("py-20", className), ...rest, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    (title || subtitle) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("mb-12", centered && "text-center"), children: [
